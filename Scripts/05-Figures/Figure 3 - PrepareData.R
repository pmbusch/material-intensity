## =============================================================================
## Figure 3 - PrepareData.R
## Runs the expensive models behind Figure 3 once and caches the results, so
## "Figure 3 - VariableImportance.R" only has to load CSVs and plot.
##
...
##     not used by Figure 3 and are skipped here)
...
# 19-Decoupling.R, for Figure 3's scatter colour -- additive column, independent
...
# re-derived here, so Figure 3 panel b's growth-rate axes are numerically
...
# Family palette -- identical to the bar panel's family_pal (Figure 3 -
...
cat("=== Figure 3 - Prepare Data done ===\n")
