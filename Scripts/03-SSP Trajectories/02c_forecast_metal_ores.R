...
## Forward Dynamic Stock Model (DSM) forecast for Metal Ores, 2025-FORECAST_END.
## Five SSP scenarios; cohort-based; lifetime distributions from Script 02b.
##
## Inputs:
##   Inputs/MatIntensity_Assumptions.xlsx  sheet MetalOres
...
##
## Outputs:
##   Results/stock_trajectory_metal_ores.csv
##   Results/stock_age_profile_metal_ores.csv
##   Results/metal_ores_forecast.csv
##   Figures/Forecast/metal_ores_stock_trajectory.png
##   Figures/Forecast/metal_ores_production.png
## =============================================================================
...
cat("  Calibrated global stock 2024 Metal Ores (Script 02b):", round(stock_2024_cal, 1), "Mt\n")
